...
export const WIDGET_TEMPLATES: Record<string, WidgetTemplate> = {
  ...
  revenue_mtd: {
    ...
    defaultSize: { w: 3, h: 2 },
    minSize: { w: 2, h: 2 },
    dataEndpoint: '/api/v1/analytics/revenue',
    refreshInterval: 300,
    category: 'revenue',
    icon: '💰',
    colorScheme: 'green',
  ...
  adr_trend: {
    ...
    defaultSize: { w: 3, h: 2 },
    minSize: { w: 2, h: 2 },
    dataEndpoint: '/api/v1/analytics/dashboard',
    refreshInterval: 600,
    category: 'revenue',
    icon: '📈',
    colorScheme: 'blue',
  ...
  revenue_forecast: {
    ...
    defaultSize: { w: 4, h: 3 },
    minSize: { w: 3, h: 3 },
    dataEndpoint: '/api/v1/analytics/forecast',
  ...
  budget_vs_actual: {
    ...
    defaultSize: { w: 4, h: 3 },
    minSize: { w: 3, h: 3 },
    dataEndpoint: '/api/v1/analytics/budget',
    refreshInterval: 3600,
    category: 'revenue',
    icon: '⚖️',
    colorScheme: 'orange',
  ...
  occupancy_trend: {
    ...
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/analytics/occupancy',
    refreshInterval: 900,
    category: 'revenue',
    icon: '📉',
    colorScheme: 'blue',
  ...
  today_arrivals: {
    ...
    defaultSize: { w: 3, h: 2 },
    minSize: { w: 2, h: 2 },
    dataEndpoint: '/api/v1/tourism/today-overview',
    refreshInterval: 60,
    category: 'operations',
    icon: '👋',
    colorScheme: 'green',
  ...
  room_status: {
    ...
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/tourism/rooms/status',
    refreshInterval: 30,
    category: 'operations',
    icon: '🚪',
    colorScheme: 'blue',
  ...
  rooms_to_clean: {
    ...
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/tourism/housekeeping/tasks',
    refreshInterval: 60,
    category: 'operations',
    icon: '🧹',
    colorScheme: 'green',
  ...
  cleaning_progress: {
    ...
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/tourism/housekeeping/progress',
    refreshInterval: 60,
    category: 'operations',
    icon: '✅',
    colorScheme: 'green',
  ...
  staff_efficiency: {
    ...
    defaultSize: { w: 4, h: 3 },
    minSize: { w: 3, h: 3 },
    dataEndpoint: '/api/v1/analytics/staff',
    refreshInterval: 900,
    category: 'operations',
    icon: '👥',
    colorScheme: 'blue',
  ...
  guest_satisfaction: {
    ...
    defaultSize: { w: 6, h: 4 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/analytics/guests',
    refreshInterval: 900,
    category: 'guests',
    icon: '⭐',
    colorScheme: 'purple',
  ...
  guest_requests: {
    ...
    defaultSize: { w: 6, h: 3 },
    minSize: { w: 4, h: 3 },
    dataEndpoint: '/api/v1/tourism/guests/requests',
    refreshInterval: 60,
    category: 'guests',
    icon: '📝',
    colorScheme: 'orange',
