    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/availability/calendar',
          method: 'GET'
        })
      }
    },
    '/api/v1/tourism/availability/calendar'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/availability/block',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/availability/block'
  )
}
