  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/channels/connect',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/channels/connect'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/channels/sync',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/channels/sync'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/channels/push-rates',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/channels/push-rates'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/channels/pull-bookings',
          method: 'GET'
        })
      }
    },
    '/api/v1/tourism/channels/pull-bookings'
  )
}
