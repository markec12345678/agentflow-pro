    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/housekeeping/tasks',
          method: 'GET'
        })
      }
    },
    '/api/v1/tourism/housekeeping/tasks'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/housekeeping/tasks/[id]/assign',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/housekeeping/tasks/[id]/assign'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/housekeeping/tasks/[id]/complete',
          method: 'POST'
        })
      }
    },
    '/api/v1/tourism/housekeeping/tasks/[id]/complete'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/tourism/housekeeping/stats',
          method: 'GET'
        })
      }
    },
    '/api/v1/tourism/housekeeping/stats'
  )
}
