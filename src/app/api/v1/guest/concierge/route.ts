    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/guest/recommendations',
          method: 'GET'
        })
      }
    },
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/guest/message',
          method: 'POST'
        })
      }
    },
    '/api/v1/guest/message'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/guest/recommendations/[id]/accept',
          method: 'POST'
        })
      }
    },
    '/api/v1/guest/recommendations/[id]/accept'
  )
}
  ...
  return withRequestLogging(
    ...
    async () => {
      try {
        ...
        return handleApiError(error, {
          route: '/api/v1/guest/recommendations/[id]/reject',
          method: 'POST'
        })
      }
    },
    '/api/v1/guest/recommendations/[id]/reject'
  )
}
